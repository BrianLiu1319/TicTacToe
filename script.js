...
function GamePlay() {
  ...
  const checkWin = () => {
    ...
    for (let i = 0; i < row; i++) {
      if (
        currBoard[i][0] == currBoard[i][1] &&
        currBoard[i][0] == currBoard[i][2]
      ) {
        console.log("win!");
      }
    }
    ...
    for (let i = 0; i < col; i++) {
      if (
        currBoard[0][i] == currBoard[1][i] &&
        currBoard[0][i] == currBoard[2][i]
      ) {
        console.log("win!");
      }
    }
    ...
    //check diag
    if (
      currBoard[0][0] == currBoard[1][1] &&
      currBoard[0][0] == currBoard[2][2]
    ) {
      console.log("win!");
    }
    if (
      currBoard[0][2] == currBoard[1][1] &&
      currBoard[0][2] == currBoard[2][0]
    ) {
      console.log("win!");
    }
  };

  return { playRound, swapPlayer, getActivePlayer, getBoard, checkWin };
}
